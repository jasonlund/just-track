<div>
    <form wire:submit="login" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <flux:link href="#" variant="primary" class="text-sm">Forgot password?</flux:link>
        </div>
    ...
    <div class="mt-2 text-center">
        <flux:text>
            ...
            <flux:link href="{{ route('register') }}" wire:navigate variant="primary">Create an account</flux:link>
        </flux:text>
    </div>
</div>
